...
This repo is **not** an application — it is the `/onboard` **Claude Code Skill** itself (current version: v2.12.0). The "code" being maintained is:
